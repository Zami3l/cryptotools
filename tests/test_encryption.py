...
class Test_Encryption(unittest.TestCase):
    ...
    plainText2 = "0123456789".encode('utf8')
    key2 = "#$%&'()*".encode('utf-8')
    ...
    def test_substitution_cipher(self):
        ...
        cipherText = Substitution_Cipher().ascii_extented('E', self.plainText2, self.key2)
        self.assertEqual(cipherText.decode('utf8', 'ignore'), "SUWY[]_a[]")
        plainText = Substitution_Cipher().ascii_extented('D', cipherText, self.key2)
        self.assertEqual(plainText, self.plainText2)
